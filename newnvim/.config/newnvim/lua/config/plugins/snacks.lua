...
local   keymaps = {
    ...
    { "<leader>lfs", function() Snacks.picker.lsp_symbols() end, desc = "LSP Symbols" },
    { "<leader>lfS", function() Snacks.picker.lsp_workspace_symbols() end, desc = "LSP Workspace Symbols" },
    { "<leader>lfci", function() Snacks.picker.lsp_incoming_calls() end, desc = "C[a]lls Incoming", has = "callHierarchy/incomingCalls" },
    { "<leader>lfco", function() Snacks.picker.lsp_outgoing_calls() end, desc = "C[a]lls Outgoing", has = "callHierarchy/outgoingCalls" },
    -- buffers
